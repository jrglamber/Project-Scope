...
CREATE INDEX IF NOT EXISTS idx_procurements_deadline ON procurements(deadline_at_utc);
CREATE INDEX IF NOT EXISTS idx_procurements_relevance ON procurements(energy_relevance_score DESC);
...
CREATE TABLE IF NOT EXISTS predictions (
    ...
    outcome TEXT CHECK (outcome IN ('CONFIRMED','PARTIAL','MISSED','EXPIRED') OR outcome IS NULL),
